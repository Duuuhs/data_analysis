...
array_dataclear[1]="truncate table tbl_visitor_first_identification;"
...
select 
b.udc_biz_date,
b.udc_visitor_sequence,
b.udc_visitor_type
from 
(select 
 a.udc_biz_date,
 a.udc_visitor_sequence,
 a.udc_visitor_type,
 row_number() over(partition by a.udc_visitor_type,a.udc_visitor_sequence order by a.udc_ident_dttm) num
 from
 (
  select 
  udc_biz_date,
  udc_ident_dttm,	--客户识别时间戳
   (
    case
